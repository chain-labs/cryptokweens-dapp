      ...
      t.exports = function (t, e, n, f, h, g, b) {
        ...
        if (
          (P &&
            ...
            d !== Object.prototype &&
              x.next &&
              (l || i(x) === d || (u ? u(x, d) : "function" != typeof x[y] && a(x, y, m)),
              c(x, _, !0, !0),
              l && (p[_] = m))),
          "values" == h &&
            A &&
...
***************************************************************************** */
      ...
      function it(t) {
        ...
        function l(e, n) {
          var r = t.size;
          return e === tt.X
            ? (n / (r.container.width + (s.thumb.realSize - s.thumb.displaySize))) * r.content.width
            : e === tt.Y
            ? (n / (r.container.height + (f.thumb.realSize - f.thumb.displaySize))) * r.content.height
            : 0;
        }
        function p(t) {
        ...
        u(c, "click", function (e) {
          if (!n && W(e.target, [s.element, f.element])) {
            ...
            o === tt.Y &&
              ((h = u.y - i.top - f.thumb.displaySize / 2), t.setMomentum(0, A(l(o, h) - c.y, -c.y, a.y - c.y)));
          }
        }),
      ...
      function at(t) {
        ...
        i(r, "touchstart", function (n) {
          o.track(n),
            t.setMomentum(0, 0),
            0 === u && ((e = t.options.damping), (t.options.damping = Math.max(e, 0.5))),
            u++;
        }),
          ...
          function (e) {
            var n = (function (t) {
                ...
                return "wheelDeltaX" in t
                  ? { x: t.wheelDeltaX / ft.OTHERS, y: t.wheelDeltaY / ft.OTHERS }
