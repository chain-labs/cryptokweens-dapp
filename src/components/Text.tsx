...
export const fontSizes = {
  ...
  h5: { mobS: "1.6rem", tabS: "2rem", deskM: "2.4rem" },
  h6: { mobS: "1.2rem", tabS: "1.6rem", deskM: "2rem" },
  h7: { mobS: "0.8rem", tabS: "1.2rem", deskM: "1.6rem" },

  b1: { mobS: "1.6rem", tabS: "2rem", deskM: "2.4rem" },
  b2: { mobS: "1.6rem", tabS: "2rem", deskM: "2rem" },
  b3: { mobS: "1.2rem", tabS: "1.6rem", deskM: "1.6rem" },
...
export interface TextProps extends BoxProps {
  as?: "h1" | "h2" | "h3" | "h4" | "h5" | "h6" | "h7" | "b1" | "b2" | "b3" | "links";
...
const Text = ({ as = "h4", fontWeight = "regular", color, children, ...restProps }: TextProps): JSX.Element => {
